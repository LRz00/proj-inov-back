...
public class SolicitacaoRemocaoArvoreCaidaCreateDto {
    @NotBlank
    ...
    public SolicitacaoRemocaoArvoreCaidaCreateDto() {
    }

    public SolicitacaoRemocaoArvoreCaidaCreateDto(String descricao, String dataCriada, SolicitacaoStatusEnum status, Usuario solicitante, String bairro, String nomeRua) {
