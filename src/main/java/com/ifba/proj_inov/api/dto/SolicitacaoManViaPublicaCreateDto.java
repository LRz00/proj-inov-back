...
public class SolicitacaoManViaPublicaCreateDto {
    ...
    public SolicitacaoManViaPublicaCreateDto(String descricao, String dataCriada, SolicitacaoStatusEnum status, Usuario solicitante, String bairro, String nomeRua, PrioridadeEnum prioridade) {
