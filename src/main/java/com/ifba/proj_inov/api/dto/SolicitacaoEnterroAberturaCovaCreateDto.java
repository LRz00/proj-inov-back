...
public class SolicitacaoEnterroAberturaCovaCreateDto {
    @NotBlank
    ...
    public SolicitacaoEnterroAberturaCovaCreateDto() {
    }

    public SolicitacaoEnterroAberturaCovaCreateDto(String nomeRua, String bairro, String dataCriada, String numCasa, String descricao, SolicitacaoStatusEnum status, Usuario solicitante) {
