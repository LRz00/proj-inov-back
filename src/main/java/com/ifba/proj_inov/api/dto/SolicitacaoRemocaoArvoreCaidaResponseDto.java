...
public class SolicitacaoRemocaoArvoreCaidaResponseDto {
    private Long id;
    ...
    public SolicitacaoRemocaoArvoreCaidaResponseDto() {
    }

    public SolicitacaoRemocaoArvoreCaidaResponseDto(Long id, String descricao, String dataCriada, SolicitacaoStatusEnum status, Usuario solicitante, String comentarios, String bairro, String nomeRua) {
        this.id = id;
