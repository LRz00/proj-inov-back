...
public class SolicitacaoEnterroAberturaCova extends Solicitacao {
    ...
    public SolicitacaoEnterroAberturaCova(Long id, String descricao, String dataCriada, SolicitacaoStatusEnum status, Usuario solicitante, String comentarios, String nomeRua, String bairro, String numCasa) {
