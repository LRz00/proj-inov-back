...
public class SolicitacaoVistoriaCreateDto {
    ...
    public SolicitacaoVistoriaCreateDto() {
    }

    public SolicitacaoVistoriaCreateDto(String nomeRua, String bairro, String dataCriada, String numCasa, String descricao, SolicitacaoStatusEnum status, Usuario solicitante) {
